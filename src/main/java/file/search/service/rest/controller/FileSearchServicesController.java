package file.search.service.rest.controller;
...
@RestController
public class FileSearchServicesController {
	...
	private final static Logger logger = Logger.getLogger("FileSearchServicesController");
	...
	public String checkService() {
		return "File search services are up and running.";
	}
    ...
    public Result queryLucene(@RequestParam(value="query") String query,
    		@RequestParam(value="count", required = false) String countStr) 
    				throws FileSearcherException, InvalidFileSearchQueryException {
		if (!query.trim().isEmpty()) {
    		...
    		throw new InvalidFileSearchQueryException(query);
    	}
    }
