...
@Controller
public class FileSearchServicesErrorController implements ErrorController{
    ...
    private final static Logger log = Logger.getLogger("FileSearchServicesErrorController");

    /**
     * Controller for the Error Controller
     * @param errorAttributes
     */
    public FileSearchServicesErrorController(ErrorAttributes errorAttributes) {
